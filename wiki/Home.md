...
4. **[[REST-API-and-CLI|⚡ REST API & CLI Reference]]**: Detailed documentation of the Python backend REST API, developer CLI (`util`), and **[[REST-API-and-CLI#🚀-production-deployment--central-database-setup-options|Production Deployment & Central Database Setup Options]]** (Institutional VM, Cloud Container, Email Dispatch, GitHub Actions).
